...
public class TestBase {
	...
	public void OpenBrowser(String browser, String HeadLess) {
		...
		try {
			...
			if (browser.equalsIgnoreCase("chrome")) {	
				AllureLogUtil.BrowserNameAndHeadless(browser, HeadLess);
				Log.Info("Invoked chrome browser");
				AllureLogUtil.Info("Invoked chrome browser");
				...
				if(HeadLess.equalsIgnoreCase("yes"))
				{
					...
					AllureLogUtil.Info("Headless mode is invoked");
				...
				AllureLogUtil.Info("Invoked firefox browser");
				...
				AllureLogUtil.Info("Invoked internet explrore browser");
			...
			AllureLogUtil.Info("Invoked url " + url);
		} catch (Exception e) {
			e.printStackTrace();
			Log.Error("Exception occurs !!", e);
		}
	...
	public void TearDownApplication() {
		try {
			Log.Info("browser session has been terminated");
			AllureLogUtil.Info("browser session has been terminated");
			if (driver != null) {
				driver.quit();				
			}
